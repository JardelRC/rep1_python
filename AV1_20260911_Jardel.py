            ...
            if(titulo == ""):
                ...
                if(autor == ""):
                    ...
                    if(ano_publicacao > 2026):
                        print("Reinicie a operação, viajante do futuro!!")
                    else:                        
                        qtd_cadastro = int(input("Quantos exemplares estão disponíveis? "))
                        if(qtd_cadastro > 0):
                            print("Quantidade: ", qtd_cadastro)
                            print("Livro cadastrado com sucesso!")
                            print(f"Livro #{numero}: {codigo} - {titulo}")
                            print("Autor: ", autor)
                            print("Ano: ", ano_publicacao)
                            print("Disponíveis: ", qtd_cadastro)
                            print()
                        else:
                            print("Não posso cadstrar zero livros. Reinicie a operação.")
                            print()
    ...
    if(codigo == ""):
        ...
        if(matricula == ""):
            ...
            if(qtd_cadastro > 0):
                ...
                print("Quantidades disponíveis: ", qtd_cadastro)
                print("Empréstimo realizado com sucesso!")
                print()
            else:
                print("Não é possível realizar o empréstimo. Não há exempçares disponíveis.")
                print()
    print("Operação concluída! Reinicie para outras operações.")
